                ...
                child: Row(
                  children: <Widget>[
                    Container(
                      ...
                      width: 20,
                      child: Image.asset('assets/dress.png', height: 35),
                    ),
                    Expanded(
                      child: Column(
              ...
              child: Row(
                children: <Widget>[
                  Container(
                    margin: EdgeInsets.symmetric(horizontal: 35),
                    width: 20,
                    child: Image.asset('assets/sunglasses.png', height: 35),
                  ),
                  Expanded(
                    child: Column(
                      crossAxisAlignment: CrossAxisAlignment.start,
              ...
              child: Row(
                children: <Widget>[
                  Container(
                    margin: EdgeInsets.symmetric(horizontal: 35),
                    width: 20,
                    child: Image.asset('assets/console.png', height: 35),
                  ),
                  Expanded(
                    child: Column(
                      crossAxisAlignment: CrossAxisAlignment.start,
              ...
              child: Row(
                children: <Widget>[
                  Container(
                    margin: EdgeInsets.symmetric(horizontal: 35),
                    width: 20,
                    child: Image.asset('assets/sneakers.png', height: 35),
                  ),
                  Expanded(
                    child: Column(
                      crossAxisAlignment: CrossAxisAlignment.start,
              ...
              child: Row(
                children: <Widget>[
                  Container(
                    margin: EdgeInsets.symmetric(horizontal: 35),
                    width: 20,
                    child: Image.asset('assets/sports.png', height: 35),
                  ),
                  Expanded(
                    child: Column(
                      crossAxisAlignment: CrossAxisAlignment.start,
